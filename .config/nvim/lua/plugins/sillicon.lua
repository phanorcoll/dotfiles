...
-- desc: nvim-silicon is a plugin for Neovim that allows you to generate images of your code using silicon.
vim.keymap.set("n", "<leader>cc", ":Silicon<cr>", { desc = "Generate image from all code" })
vim.keymap.set("v", "<leader>cc", ":Silicon<cr>", { desc = "Generate image from selected code" })
return {
